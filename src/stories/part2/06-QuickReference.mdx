...
<div style={{ margin: '20px 0', maxWidth: '700px' }}>
  <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px', flexWrap: 'wrap', marginBottom: '8px' }}>
    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '4px' }}>
      <div style={{ padding: '4px 12px', background: '#1976d2', color: 'white', borderRadius: '12px', fontSize: '12px', fontWeight: 'bold' }}>1</div>
      <div style={{ padding: '14px 18px', background: '#e3f2fd', border: '2px solid #1976d2', borderRadius: '8px', textAlign: 'center', minWidth: '120px' }}>
        <div style={{ fontWeight: 'bold', fontSize: '14px', marginBottom: '4px' }}>환경 준비</div>
        <div style={{ fontSize: '12px', color: '#555' }}>tmux 세션 생성</div>
        <div style={{ fontSize: '12px', color: '#555' }}>레이아웃 구성</div>
        <div style={{ fontSize: '12px', color: '#555' }}>CLAUDE.md 준비</div>
      </div>
    </div>
    <div style={{ fontSize: '24px', color: '#666', fontWeight: 'bold' }}>→</div>
    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '4px' }}>
      <div style={{ padding: '4px 12px', background: '#7b1fa2', color: 'white', borderRadius: '12px', fontSize: '12px', fontWeight: 'bold' }}>2</div>
      <div style={{ padding: '14px 18px', background: '#f3e5f5', border: '2px solid #7b1fa2', borderRadius: '8px', textAlign: 'center', minWidth: '120px' }}>
        <div style={{ fontWeight: 'bold', fontSize: '14px', marginBottom: '4px', color: '#7b1fa2' }}>작업 시작</div>
        <div style={{ fontSize: '12px', color: '#555' }}>Claude Code</div>
        <div style={{ fontSize: '12px', color: '#555' }}>Agent Team</div>
        <div style={{ fontSize: '12px', color: '#555' }}>프롬프트 입력</div>
      </div>
    </div>
    <div style={{ fontSize: '24px', color: '#666', fontWeight: 'bold' }}>→</div>
    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '4px' }}>
      <div style={{ padding: '4px 12px', background: '#388e3c', color: 'white', borderRadius: '12px', fontSize: '12px', fontWeight: 'bold' }}>3</div>
      <div style={{ padding: '14px 18px', background: '#e8f5e9', border: '2px solid #388e3c', borderRadius: '8px', textAlign: 'center', minWidth: '120px' }}>
        <div style={{ fontWeight: 'bold', fontSize: '14px', marginBottom: '4px', color: '#2e7d32' }}>모니터링</div>
        <div style={{ fontSize: '12px', color: '#555' }}>pane 분할로</div>
        <div style={{ fontSize: '12px', color: '#555' }}>에이전트 관찰</div>
        <div style={{ fontSize: '12px', color: '#555' }}>리소스 모니터</div>
      </div>
    </div>
  </div>
  <div style={{ display: 'flex', justifyContent: 'center', fontSize: '24px', color: '#666', margin: '4px 0' }}>↓</div>
  <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px', flexWrap: 'wrap' }}>
    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '4px' }}>
      <div style={{ padding: '4px 12px', background: '#ff9800', color: 'white', borderRadius: '12px', fontSize: '12px', fontWeight: 'bold' }}>5</div>
      <div style={{ padding: '14px 18px', background: '#fff3e0', border: '2px solid #ff9800', borderRadius: '8px', textAlign: 'center', minWidth: '120px' }}>
        <div style={{ fontWeight: 'bold', fontSize: '14px', marginBottom: '4px', color: '#e65100' }}>정리</div>
        <div style={{ fontSize: '12px', color: '#555' }}>로그 캡처</div>
        <div style={{ fontSize: '12px', color: '#555' }}>결과 저장</div>
        <div style={{ fontSize: '12px', color: '#555' }}>세션 정리</div>
      </div>
    </div>
    <div style={{ fontSize: '24px', color: '#666', fontWeight: 'bold' }}>→</div>
    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '4px' }}>
      <div style={{ padding: '4px 12px', background: '#d32f2f', color: 'white', borderRadius: '12px', fontSize: '12px', fontWeight: 'bold' }}>4</div>
      <div style={{ padding: '14px 18px', background: '#ffebee', border: '2px solid #d32f2f', borderRadius: '8px', textAlign: 'center', minWidth: '120px' }}>
        <div style={{ fontWeight: 'bold', fontSize: '14px', marginBottom: '4px', color: '#c62828' }}>결과 확인</div>
        <div style={{ fontSize: '12px', color: '#555' }}>코드 리뷰</div>
        <div style={{ fontSize: '12px', color: '#555' }}>테스트 실행</div>
        <div style={{ fontSize: '12px', color: '#555' }}>머지 & 커밋</div>
      </div>
    </div>
  </div>
</div>
